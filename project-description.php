    ...
    <div class="w3-container ">
      ...
      <div class="w3-col l7 m6 w3-margin-bottom w3-left">
        <div class="w3-container">
          ...
          <a href="https://mail.google.com/mail/?view=cm&fs=1&tf=1&to=<?php echo $emailStudent1; ?>&su='Project Consultation'&body=" class="w3-button w3-light-grey"><i class="fa fa-phone-square w3-margin-right"></i>Contact Creator</a>
        </div>
      </div>
    </div>
